...
content = re.sub(r'''LOGGER\.log\(Level\.SEVERE, "Failed to open Note Editor dialog: " \+ e\.getMessage\(\), e\);''',
                 r'LOGGER.log(Level.SEVERE, "Failed to open Note Editor dialog: " + e.getMessage(), e);\n            UiUtils.showError("Error", "Failed to open Note Editor dialog: " + e.getMessage());', content)
...
content = re.sub(r'''LOGGER\.log\(Level\.SEVERE, "Could not open note editor: " \+ e\.getMessage\(\), e\);''',
                 r'LOGGER.log(Level.SEVERE, "Could not open note editor: " + e.getMessage(), e);\n            UiUtils.showError("Error", "Could not open note editor: " + e.getMessage());', content)
