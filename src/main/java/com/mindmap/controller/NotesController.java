...
public class NotesController {
    ...
    @FXML private TableColumn<Note, Boolean> colFavorite;
    ...
    public NotesController(SearchService searchService, NoteService noteService) {
    ...
    private void handleExportPdf() {
        ...
        java.io.File file = fileChooser.showSaveDialog(tableResults.getScene().getWindow());
        if (file != null) {
            final PdfExportService pdfService = new PdfExportService();
            final Note noteToExport = noteService.getNoteWithTags(selected.getId()).orElse(selected);
